...
if (SpeechRecognition) {
  ...
  console.log("Seu navegador não suporta a API de reconhecimento de fala");
}

function takeCommand(message) {
  if (message.includes("ola") || message.includes("ei, jarvis")) {
    speak("Ola Senhor(a), Como eu posso ajudar você?");
